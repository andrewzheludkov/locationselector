...
$L['ls_addcity'] = 'Добавить место';
$L['ls_cities'] = 'Места';
$L['ls_nocities'] = 'Список мест пуст';

$L['ls_newcity_newstr'] = 'каждое место в отдельной строке';
$L['ls_newcity_list'] = 'Укажите список мест';

$L['select_country'] = ' Выберите страну';
$L['select_region'] = ' Выберите регион';
$L['select_city'] = ' Выберите город';
$L['select_place'] = ' Выберите место';
