...
if(!empty($location['country'])) $where['location'] = "page_country='" . $db->prep($location['country'])."'";
if((int)$location['region'] > 0) $where['location'] =  "page_region=" . (int)$location['region'];
if((int)$location['city'] > 0) $where['location'] = "page_city=" . (int)$location['city'];
